        ...
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
         <span aria-hidden="true">&times;</span>
          ...
          isset($city) && isset($password) )
  		{
  		  ...
  		  $sql="INSERT INTO donar (name,gender,email,city,dob,contact_no,save_life_data,password,blood_group) VALUES ('$name','$gender','$email','$city','$DonnerDOB','$contact','0','$password','$blood_group')";
